...
class EventTest {
    ...
    class Creation {
        ...
        void should_create_event_with_valid_parameters() {
            ...
            // When
            Event event = new Event(identifier, "Noël", "Fête", FUTURE_DATE, RECIPIENTS);

            // Then
            assertThat(event.identifier()).isEqualTo(identifier);
            assertThat(event.title()).isEqualTo("Noël");
    ...
    class DueDateCheck {
        ...
        void should_be_due_when_current_time_is_after_due_date() {
            ...
            Event event = new Event(EventId.generate(), "Passé", "desc", pastDate, RECIPIENTS);
        ...
        void should_not_be_due_when_due_date_is_in_the_future() {
            // Given
            Event event = new Event(EventId.generate(), "Futur", "desc", FUTURE_DATE, RECIPIENTS);
